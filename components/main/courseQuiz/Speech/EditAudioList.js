...
function EditAudioList({ route, navigation }) {
        ...
        renderItem={({ item }) => {
          return (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate({name:"EditSpeechQuestionItem", params : { item: item }, merge:  true})}
            >
