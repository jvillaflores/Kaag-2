...
function Validation({ currentUser, route, navigation }) {
  ...
  const saveAllPostDataWithoutAudio = () => {
    firebase
      .firestore()
      .collection("languages")
      .doc(data?.language)
      ...
      const resubmitDeclined = (downloadURL) => {
        firebase
          .firestore()
          .collection("languages")
          .doc(data?.language)
      ...
      const resubmitDeclinedWithoutAudio = () => {
        firebase
          .firestore()
          .collection("languages")
          .doc(data?.language)
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.center}>
          ...
          <View style={styles.paddingLeft}>
            <Text style={styles.title_text}>In English</Text>
          ...
          <View style={styles.row}>
            {audio ? (<Pressable style={styles.buttonAccept} onPress={() => UpdateDeclined()}>
              <Text style={styles.subtitle}>
                {loading ? "Updating..." : "Update"}
              </Text>
            </Pressable>) : (<Pressable style={styles.buttonAccept} onPress={() => resubmitDeclinedWithoutAudio()}>
              <Text style={styles.subtitle}>
                {loading ? "Updating..." : "Update"}
              </Text>
            </Pressable>)}
    ...
    return (
      <ScrollView style={styles.container}>
        <View style={styles.center}>
          ...
          <View style={styles.row}>
            {audio ? (<Pressable style={styles.buttonAccept} onPress={() => Update()}>
              <Text style={styles.subtitle}>
                {loading ? "Updating..." : "Update"}
              </Text>
            </Pressable>) : (<Pressable style={styles.buttonAccept} onPress={() => saveAllPostDataWithoutAudio()}>
              <Text style={styles.subtitle}>
                {loading ? "Updating..." : "Update"}
              </Text>
            </Pressable>)}
